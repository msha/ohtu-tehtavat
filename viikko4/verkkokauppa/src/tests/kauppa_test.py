...
class TestKauppa(unittest.TestCase):
    ...
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            ...
            if tuote_id == 2:
                return Tuote(1, "karkki", 1)
            if tuote_id == 3:
                return Tuote(1, "olut", 15)
    ...
    def test_tee_ostos_varastosta_olevasta_tuotteesta_tilimaksulla(self):
    ...
    def test_tee_ostos_ja_peru_ostos_paata_tilimaksulla(self):
    ...
    def test_tee_ostos_kahdesta_eri_varastosta_olevasta_tuotteesta_tilisiirrolla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_tee_ostos_kahdesta_varastosta_olevasta_tuotteesta_tilisiirrolla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka","12345")
    ...
    def test_tee_ostos_loppuneesta_ja_varastosta_olevasta_tuotteesta_tilisiirrolla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
